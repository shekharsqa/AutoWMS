package com.autowms.dataprovider;
...
import com.autowms.utility.NewExcelLibrary;
...
//Class --> LoginPageTest,HomePageTest Test Case--> loginTest, wishListTest, orderHistoryandDetailsTest
	...
	@DataProvider(name = "credentials") //This is just a name but we will keep same as sheet name in TestData.xlsx
	public Object[][] getCredentials() {
		// Totals rows count
		int rows = obj.getRowCount("Credentials"); //SJSH- This is worksheet Name(sheet in TestDat.xlsx file) Which tab this will read for row.
		// Total Columns
		int column = obj.getColumnCount("Credentials"); //SJSH- This is worksheet Name(sheet in TestDat.xlsx file) Which tab this will read for column.
		int actRows = rows - 1;
...
//Class --> AddToCartPageTest, EndToEndTest,  Test Case--> addToCartTest, endToEndTest	
	...
	public Object[][] getValidations() {
		...
		// Totals rows count
		int rows = obj.getRowCount("Validations");
		// Total Columns
		int column = obj.getColumnCount("Validations");
		int actRows = rows - 1;
